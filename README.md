## This is a fork from [Azure OpenAI client library for .NET](https://github.com/Azure/azure-sdk-for-net/tree/Azure.AI.OpenAI_1.0.0-beta.12/sdk/openai/Azure.AI.OpenAI)
